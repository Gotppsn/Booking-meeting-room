        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameTh = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    NameJa = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DescriptionTh = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    DescriptionJa = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Departments",
                columns: new[] { "Id", "ColorCode", "CreatedAt", "IsActive", "Name", "NameJa", "NameTh", "UpdatedAt" },
                values: new object[,]
                {
                    { 1, "#2563EB", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), true, "Administration", "管理部", "ฝ่ายบริหาร", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) },
                    { 2, "#10B981", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), true, "Information Technology", "情報技術部", "ฝ่ายเทคโนโลยีสารสนเทศ", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) },
                    { 3, "#F59E0B", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), true, "Human Resources", "人事部", "ฝ่ายทรัพยากรบุคคล", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_RoomId_StartDateTime_EndDateTime",
                table: "Bookings",
